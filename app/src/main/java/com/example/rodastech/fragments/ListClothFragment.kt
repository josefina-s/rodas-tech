...
//        }
        ...
        adapter = ClothAdapter(clothRepository.cloths){position->
            val actionDelete = ListClothFragmentDirections.actionListClothFragmentToDeleteClothFragment(clothRepository.cloths[position],clothRepository.cloths.toTypedArray())
            findNavController().navigate(actionDelete)
        }
